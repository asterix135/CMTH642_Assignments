...
# Average non-average-quality f-stat for our model
test_f <- mean(c(0,0,0,(2*cm2$byClass[5,1] * cm2$byClass[5,3])/ 
                     (cm2$byClass[5,1] + cm2$byClass[5,3])))
test_f
```
...
model_summary[3,2] <- cm2$overall[1]
...
We will look at how the model works for both our testing data set.
...
model_summary <- rbind(model_summary, rep(NA, 3))
model_summary[4,1] <- 'reshaped_test'
